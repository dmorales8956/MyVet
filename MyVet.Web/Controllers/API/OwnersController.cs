...
namespace MyVet.Web.Controllers.API
{
    ...
    {
        private readonly DataContext _dataContesxt;

        public OwnersController(DataContext dataContesxt)
        {
            _dataContesxt = dataContesxt;
        }
        ...
        public async Task<IActionResult> GetOwner(EmailRequest emailRequest)
        {
            ...
            var owner = await _dataContesxt.Owners
                 .Include(o => o.User)
                 .Include(o => o.Pets)
