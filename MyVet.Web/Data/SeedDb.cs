...
namespace MyVet.Web.Data
{
    public class SeedDb
    {
        ...
        private async Task CheckOwnersAsync()
        {
            ...
            {
                AddOwner("5698745", "Diana", "Morales", "244 5982", "310 384 3481", "Calle Estrella Calle Luna");
                AddOwner("5895544", "Fernando", "Torres", "589 3826", "311 372 3221", "Calle 88 #22 21");
                AddOwner("8455585", "julia", "Caña", "326 4872", "300 362 3221", "Carrera 45 #22 21");
                await _context.SaveChangesAsync();
            }
        }
