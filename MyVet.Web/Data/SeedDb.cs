...
namespace MyVet.Web.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckRoles();
            var manager = await CheckUserAsync("1234", "Diana", "Morales", "dmorales8956@gmail.com", "310 384 0327", "Calle Estrella Calle Luna", "Admin");
            var customer = await CheckUserAsync("1234", "Diana", "Morales", "dianammmye@hotmail.com", "314 634 9847", "Calle Pan Calle Agua", "Customer");
